...
Usage Instructions:
    10-shot sinusoid:
        ...
        python main.py --datasource=sinusoid --logdir=logs/sine/ --metatrain_iterations=70000 --norm=None --update_batch_size=10 --train=False --test_set=True
...
def main():
    if FLAGS.datasource == 'sinusoid':
        if FLAGS.train:
            test_num_updates = 5 # the number of gradient steps taken at meta-test time
        else:
            test_num_updates = 10
    else:
